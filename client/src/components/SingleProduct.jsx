    ...
    <div>
      <div className=" max-w-screen-xl mx-10 my-10 flex justify-center gap-10">
        <div className="w-2/5 relative">
          <img
          className="w-96 h-full object-center"
          src={details.image}
          alt="productImg"
          />
          ...
          {details.isNew && (
            ...
            text-white font-semibold font-titleFont px-8 py-1">
            Sale
            </p>
          )}
          </div>
        ...
        <div className="w-3/5 flex flex-col justify-center gap-12">
            <div>
              ...
              <div className="flex items-center gap-4 mt-3">
                ...
                <p className="text-2x1 font-medium Itext-gray-900">
                ${details.price}
                </p>
              </div>
            </div>
            ...
            <div className='flex gap-4'>
              <div className="w-52 flex items-center justify-between text-gray-500 gap-4 border p-3">
                ...
                <div className="flex items-center gap-4 text-sm font-semibold">
                  <button onClick={() => baseQty > 1 && setbaseQty(baseQty-1)} className="border h-5 font-normal text-lg flex items-center
